...
export const Layout: React.FC<LayoutProps> = ({
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-slate-50 dark:bg-slate-950 transition-colors duration-300">
      ...
      {/* Mobile Menu Overlay */}
      {isMobileMenuOpen && (
        <div className="fixed inset-0 z-20 bg-white dark:bg-slate-900 pt-20 px-6 md:hidden animate-fade-in">
      ...
      >
        {/* Top Header Bar */}
        <header className="h-16 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 flex justify-between items-center px-8 z-10 sticky top-0 hidden md:flex">
